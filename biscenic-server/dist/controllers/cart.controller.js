...
const addToCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedCart = yield cartService.addToCart(userId, productId, quantity);
...
const getCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const cart = yield cartService.getCartByUser(userId);
...
const removeFromCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedCart = yield cartService.removeFromCart(userId, productId);
